...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-4 z-30 md:top-8">
      <div className="relative mx-auto flex h-[100px] max-w-2xl items-center justify-center px-4 md:px-0">
